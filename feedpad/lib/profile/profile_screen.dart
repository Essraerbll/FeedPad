...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadUserData() async {
    ...
    if (_currentUser != null) {
      try {
        final userData = await _userRepository.fetchUserProfile(
          _currentUser!.uid,
        );
        ...
        if (userData != null) {
          ...
          if (mounted) {
            setState(() {
              _isLoading = false;
              _errorMessage =
                  'Profil verisi veritabanında bulunamadı. Lütfen "Tekrar Dene/Oluştur" butonuna basın.';
            });
          }
        }
      } catch (e) {
        if (mounted) {
          setState(() {
            _errorMessage =
                'Veri çekme hatası! Güvenlik kurallarını veya ağ bağlantınızı kontrol edin.';
            _isLoading = false;
          });
        }
      }
                  ...
                  children: [
                    ...
                    Card(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(
                          _userData?['bio'] ?? 'Biyografi henüz eklenmedi.',
                        ),
                      ),
                    ),
                    ...
                    Card(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(
                          _userData?['location'] ?? 'Konum bilgisi yok.',
                        ),
                      ),
                    ),
